...
class PathParser {
    ...
    /**
     * Copies elements from {@code originalPath} into a new array, from indexes start (inclusive) to
     * end (exclusive). The originalPath order of elements is preserved.
     * If {@code end} is greater than {@code originalPath.length}, the result is padded
     * with the value {@code 0.0f}.
     *
     * @param original the originalPath array
     * @param start    the start index, inclusive
     * @param end      the end index, exclusive
     * @return the new array
     * @throws ArrayIndexOutOfBoundsException if {@code start < 0 || start > originalPath.length}
     * @throws IllegalArgumentException       if {@code start > end}
     * @throws NullPointerException           if {@code originalPath == null}
     */
     ...
     *
     * @param s the string containing a command and layers of floats
